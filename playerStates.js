...
export class Running extends State {
    ...
    handleInput(input) {
        this.game.particles.unshift(new Dust(this.game, this.game.player.x + this.game.player.width * .65, this.game.player.y + this.game.player.height));
...
export class Rolling extends State {
    ...
    handleInput(input) {
        this.game.particles.unshift(new Fire(this.game, this.game.player.x + this.game.player.width * .5, this.game.player.y + this.game.player.height * 0.5));
